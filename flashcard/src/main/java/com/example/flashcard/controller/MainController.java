...
//        subjects.add(physics);
    ...
    private void loadSidebarTree() {
        String imagePathContentArea = getClass().getResource("/com/example/flashcard/images/mainFlashcardBackground.png").toExternalForm();
        ...
        String imagePathSidebar = getClass().getResource("/com/example/flashcard/images/sidebarBackground.png").toExternalForm();
        sidebar.setStyle(
    ...
    private void loadCurrentFlashcard(StackPane container, Label counterLabel) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/flashcard/styles/flashcard-single-view.fxml"));
